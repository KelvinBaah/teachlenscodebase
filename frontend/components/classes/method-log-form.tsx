  ...
  return (
    <div className="space-y-4">
      {recommendations.length > 0 ? (
        <div className="rounded-[24px] border border-slate-200 bg-slate-50/70 p-5">
          <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
            <div>
              <h4 className="text-lg font-semibold text-ink">Quick Log a Recommended Method</h4>
            ...
            <div className="rounded-full bg-white px-4 py-2 text-xs font-medium uppercase tracking-[0.16em] text-clay">
              Adjust
            </div>
          </div>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2">
            {recommendations.map((recommendation) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-ink">{recommendation.method_name}</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">
                ...
                <button
                  type="submit"
                  className="mt-4 rounded-full bg-pine px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#184a3c]"
                >
                  Log This Method
                </button>
              </form>
      ...
      >
        <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
          <div>
            <h4 className="text-lg font-semibold text-ink">Teaching Method Log</h4>
            <p className="mt-2 text-sm leading-6 text-slate-600">
          ...
          <div className="rounded-full bg-mist px-4 py-2 text-xs font-medium uppercase tracking-[0.16em] text-pine">
            Teach
          </div>
        </div>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700" htmlFor="logDate">
              Week or Date
            </label>
            <input
              id="logDate"
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700" htmlFor="wasRecommended">
              Was it recommended?
            </label>
            <select
              id="wasRecommended"
          ...
          <div className="space-y-2 md:col-span-2">
            <label className="text-sm font-medium text-slate-700" htmlFor="methodUsed">
          ...
          <div className="space-y-2 md:col-span-2">
            <label className="text-sm font-medium text-slate-700" htmlFor="reflectionNote">
